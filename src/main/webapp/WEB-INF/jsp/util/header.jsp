        ...
        <div class="topbar-left">
            <div class="text-center p-t-10" style="margin: 0 auto;">
                <div class="pull-left" style="padding-left: 10px;">
                    <a href="/admin/index">
                        <img src="/resource/image/logo.jpg" width="50" height="50"/>
                    </a>
                </div>
                <div class="pull-left" style="padding-left: 10px;">
                    <span style="font-size: 28px; color: #2f353f; line-height: 50px;">Man ge</span>
                </div>
            </div>
        </div>
                    ...
                    <ul class="nav navbar-nav navbar-right pull-right">
                        <li class="dropdown">
                            ...
                            <ul class="dropdown-menu">
                                <li><a href="/list" target="_blank"><i class="fa fa-eye" aria-hidden="true"></i>
                                    查看网站</a></li>
    ...
    <div class="left side-menu">
        <div class="sidebar-inner slimscrollleft">
            <div id="sidebar-menu">
                <ul>
                    <li class="active">
                        <a href="/admin/index" class="waves-effect home"><i class="fa fa-dashboard"
                    ...
                    <li class="active" #end>
                        <a href="/admin/article" class="waves-effect active #end"><i class="fa fa-list"
                    ...
                    <li class="has_sub">
                        <a href="javascript:void(0)" class="waves-effect  active subdrop #end"><i
